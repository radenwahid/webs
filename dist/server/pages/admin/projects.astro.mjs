import { f as createComponent, j as renderComponent, r as renderTemplate, i as createAstro, m as maybeRenderHead, h as addAttribute } from '../../chunks/astro/server_5CbLVaOW.mjs';
import 'kleur/colors';
  ...
  if (Astro2.request.method === "POST") {
    ...
    if (action === "upload") {
      ...
      if (file && file.size > 0) {
        ...
        const { data, error } = await supabaseAdmin.storage.from("projects").upload(filename, file, { contentType: file.type, upsert: false });
        if (!error && data) {
